...
export class DashboardModel {
  ...
  //   try {
  //     const { idFarmer, idGreenhouse } = input;
  ...
  //   } catch (error) {
  //     throw new Error(
  //       "Error al obtener el total de imágenes analizadas por agricultor e invernadero desde la base de datos"
  //     );
  //   }
  // }
  ...
  //   } catch (error) {
  //     throw new Error(
  //       "Error al obtener el cultivo más atacado por agricultor e invernadero desde la base de datos"
  //     );
  //   }
  // }
  ...
  //   } catch (error) {
  //     throw new Error(
  //       "Error al obtener las enfermedades por agricultor e invernadero desde la base de datos"
  //     );
  //   }
  // }
  ...
  //   } catch (error) {
  //     throw new Error(
  //       "Error al obtener las plagas por agricultor e invernadero desde la base de datos"
  //     );
  //   }
  // }
}
